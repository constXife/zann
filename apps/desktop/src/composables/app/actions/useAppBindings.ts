...
export function useAppBindings(options: AppBindingsOptions) {
  ...
  const shellBindings = {
    ...
    openConfirm: confirmState.openConfirm,
    ...
    selectedSubtype: selectionState.selectedSubtype,
    selectCategory: selectionState.selectCategory,
    selectSubtype: selectionState.selectSubtype,
    ...
    showAllTypesOption: createState.showAllTypesOption,
    enableAllTypes: createState.enableAllTypes,
    openTypeMenuOnOpen: createState.openTypeMenuOnOpen,
    consumeOpenTypeMenu: createState.consumeOpenTypeMenu,
    ...
    createTypeLocked: createState.createTypeLocked,
    ...
    loadTypeOptions: createState.loadTypeOptions,
