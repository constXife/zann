...
- `K6_PROFILE` (e.g. `normal`, `peak`, `soak`, `signup_peak`)
...
- `VM_URL`, `CPU_QUERY`, `MEM_QUERY`, `ZANN_MONITOR_INTERVAL`
- `ZANN_MEM_LIMIT_BYTES`, `ZANN_CPU_LIMIT`

## Examples

```
K6_PROFILE=normal k6 run loadtest/k6/scenarios/baseline_normal.js
K6_REGISTER_ENABLED=1 K6_PROFILE=normal k6 run loadtest/k6/scenarios/baseline_normal.js
...
```
K6_SCENARIO=baseline_normal K6_PROFILE=normal k6 run loadtest/k6/runner.js
...
```
K6_SCENARIO=baseline_normal K6_PROFILE=normal ./loadtest/run_k6.sh run loadtest/k6/runner.js
```
...
```
K6_SCENARIO=baseline_normal K6_PROFILE=normal ./loadtest/run_scenario.sh run loadtest/k6/runner.js
...
```
K6_SCENARIO=baseline_normal K6_PROFILE=normal ./loadtest/run_loadtest.sh
